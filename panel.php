    ...
    <body>
        ...
        <div id="content">
            ...
            <div class="gs-cbigbox tab">
                <ul class="gs-tab-nav">
                    <li data-ref="tabs-1">Bloco 1</li>
                    <li data-ref="tabs-2">Bloco 2</li>
                    <li data-ref="tabs-3">Bloco 3</li>
                </ul>
            ...
            <div class="gs-cbigbox tab pills">
                <ul class="gs-tab-nav">
                    <li data-ref="tabs-4">Bloco 1</li>
                    <li data-ref="tabs-5">Bloco 2</li>
                    <li data-ref="tabs-6">Bloco 3</li>
                </ul>
            ...
            <div class="gs-cbigbox half">
                ...
                <ul class="gs-infolist">
                    <li><b>Endereço de SMTP:</b> smtp.dominio.com</li>
            ...
            <div class="gs-cbigbox">
                ...
                <label class="gs-flabel">
                    <div class="gs-prefix-group">
                        <span class="gs-addon icon fa fa-search"></span>
                        <input class="gs-ftext" type="text" name="search" id="search1" placeholder="Pesquisar">
                    </div>
                </label>
                    ...
                    <table id="table1" class="gs-table" data-tpager="pager1">
                        <thead>
                            <tr>
                                ...
                                <th style="min-width: 200px">Enviado por</th>
                                <th style="min-width: 120px">Prioridade</th>
                                <th style="min-width: 220px">Data</th>
                ...
                <div id="pager1" class="gs-tpager">
                    <a class="gs-pnumber active">1</a>
                    <a class="gs-pnumber">2</a>
                    <a class="gs-pnumber">3</a>
                    <a class="gs-pnumber">4</a>
                    <a class="gs-pnumber">5</a>
                    <a class="gs-pnumber"6>6</a>
                </div>
            </div>
                ...
                <form name="form1" method="post" action="">
                    ...
                    <label class="gs-flabel">
                        ...
                        <div class="gs-prefix-group">
                            ...
                            <input class="gs-ftext gs-withpre" type="text" name="username" id="username">
                        </div>
                    </label>
                    <label class="gs-flabel">
                        <b>Subdomínio</b>
                        <div class="gs-prefix-group">
                            ...
                            <span class="gs-addon">.gficher.tk</span>
                        </div>
                    </label>
                    <label class="gs-flabel success">
                        <b>Subdomínio</b>
                        <div class="gs-prefix-group">
                            <input class="gs-ftext gs-withpre both" type="text" name="username" id="username">
                            <span class="gs-addon">batatas</span>
                        </div>
                    </label>
